...
def main(opt, run_count):
    ...
    for epoch in range(1, opt["epoch"]):
        ...
        print(
            log.format(
                ...
                results["time"][-1],
                results["loss"][-1],
                results["forward_nfe"][-1],
                results["backward_nfe"][-1],
                results["train_acc"][-1],
                results["val_acc"][-1],
                results["test_acc"][-1],
            )
    ...
    print(
        "best val accuracy {:03f} with test accuracy {:03f} at epoch {:d}".format(
            best_val_acc, best_test_acc, best_epoch
        )
    )
    ...
    pickle.dump(
        results,
        open(
            f"../results/{opt['dataset']}_{opt['method']}_stepsize_{opt['dt']}_run_{run_count}.pickle",
            "wb",
        ),
    )

best_params_dict = {
    ...
    "Citeseer": {
        ...
        "heat_time": 3.0,
        "hidden_dim": 80,
        "input_dropout": 0.6803233752085334,
        "jacobian_norm2": None,
        "kinetic_energy": None,
        "label_rate": 0.5,
        "leaky_relu_slope": 0.5825086997804176,
        "lr": 0.00863585231323069,
        "max_epochs": 1000,
        "max_iters": 100,
        "max_nfe": 3000,
        "method": "dopri5",
    ...
    "CoauthorCS": {
        ...
        "data_norm": "rw",
        "dataset": "CoauthorCS",
        "decay": 0.004738413087298854,
        "directional_penalty": None,
        "dropout": 0.6857774850321,
        "dt": 0.001,
        "dt_min": 1e-05,
        "edge_sampling": False,
        "edge_sampling_T": "T0",
        ...
        "edge_sampling_space": "pos_distance",
        ...
        "gdc_method": "ppr",
        "gdc_sparsification": "topk",
        "gdc_threshold": 0.0001,
        "gpus": 1,
        "grace_period": 20,
        "heads": 4,
        "heat_time": 3.0,
        "hidden_dim": 16,
        "input_dropout": 0.5275042493231822,
        "jacobian_norm2": None,
        "kinetic_energy": None,
        "label_rate": 0.5,
        "leaky_relu_slope": 0.7181389780997276,
        "lr": 0.0009342860080741642,
        "max_iters": 100,
        "max_nfe": 3000,
        "method": "dopri5",
        "metric": "accuracy",
        "mix_features": False,
        "name": "CoauthorCS_final_tune_posencGDC",
        "new_edges": "random",
        "no_alpha_sigmoid": False,
        "not_lcc": True,
        "num_init": 1,
    ...
    "Computers": {
        ...
        "alpha": 1.0,
        "alpha_dim": "sc",
        "att_samp_pct": 0.572918052062338,
        "attention_dim": 64,
        "attention_norm_idx": 0,
        "attention_rewiring": False,
        "attention_type": "scaled_dot",
        ...
        "data_norm": "rw",
        "dataset": "Computers",
        "decay": 0.007674669913252157,
        "directional_penalty": None,
        "dropout": 0.08732611854459256,
        "dt": 0.001,
        "dt_min": 1e-05,
        "epoch": 100,
        "exact": False,
        ...
        "heat_time": 3.0,
        "hidden_dim": 128,
        "input_dropout": 0.5973137276937647,
        "jacobian_norm2": None,
        "kinetic_energy": None,
        "label_rate": 0.5,
        "leaky_relu_slope": 0.2,
        "lr": 0.0035304663972281548,
        "max_epochs": 1000,
        "max_iters": 100,
        "max_nfe": 500,
        "method": "dopri5",
        "metric": "accuracy",
        "mix_features": False,
        "name": "computer_beltrami_hard_att1",
        "new_edges": "random",
        "no_alpha_sigmoid": False,
        "not_lcc": True,
        "num_init": 1,
        ...
        "tol_scale": 127.46369887079446,
        "tol_scale_adjoint": 443.81436775321754,
        "total_deriv": None,
        "use_cora_defaults": False,
        "use_flux": False,
        "use_labels": False,
    ...
    "Photo": {
        ...
        "alpha": 1.0,
        "alpha_dim": "sc",
        "att_samp_pct": 0.9282359956104751,
        "attention_dim": 64,
        "attention_norm_idx": 0,
        "attention_rewiring": False,
        "attention_type": "pearson",
        "augment": False,
        "baseline": False,
        "batch_norm": True,
        "beltrami": False,
        ...
        "data_norm": "rw",
        "dataset": "Photo",
        "decay": 0.004707800883497945,
        "directional_penalty": None,
        "dropout": 0.46502284638600183,
        "dt": 0.001,
        "dt_min": 1e-05,
        "epoch": 100,
        "exact": False,
        ...
        "heat_time": 3.0,
        "hidden_dim": 64,
        "input_dropout": 0.42903126506740247,
        "jacobian_norm2": None,
        "kinetic_energy": None,
        "label_rate": 0.5,
        "leaky_relu_slope": 0.2,
        ...
        "rw_addD": 0.02,
        "rw_rmvR": 0.02,
        "self_loop_weight": 0.05783612585280118,
        "sparsify": "S_hat",
        "square_plus": False,
        "step_size": 1,
        "threshold_type": "addD_rvR",
        "time": 3.5824027975386623,
        "tol_scale": 2086.525473167121,
        "tol_scale_adjoint": 14777.606112557354,
        "total_deriv": None,
        "use_cora_defaults": False,
        "use_flux": False,
        "use_labels": False,

...
def main(opt):
    ...
    # - if so, just load them
    print(
        f"positional encodings retrieved after {time.time()-start_time} seconds. Starting matrix factorisation"
    )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--rewiring", action="store_true", help="Whether to rewire the dataset with GDC"
    )
    parser.add_argument(
        "--exact", action="store_true", help="Whether to approximate ppr"
    )
    parser.add_argument(
        "--data_path", type=str, default=".", help="path to the positional encoding"
    )
    parser.add_argument("--pos_enc_orientation", type=str, default="row", help="")
    parser.add_argument(
        "--out_dir",
        type=str,
        default="../data",
        help="path to save compressed encoding",
    )
    ...
    parser.add_argument(
        ...
        type=int,
        default=1000,
        help="dimension of compressed encoding",
    )
    parser.add_argument(

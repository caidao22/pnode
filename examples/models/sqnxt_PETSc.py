...
class BasicBlock(nn.Module):
    def __init__(self, in_channels, out_channels, stride):
        ...
        self.conv1 = nn.Conv2d(
            in_channels, int(in_channels * reduction), 1, stride, bias=True
        )
        ...
        self.conv5 = nn.Conv2d(
            int(in_channels * reduction), out_channels, 1, 1, bias=True
        )
...
class SqueezeNext(nn.Module):
    def __init__(self, width_x, blocks, num_classes, ODEBlock_):
        ...
        self.conv1 = nn.Conv2d(
            3, int(width_x * self.in_channels), 3, 1, 1, bias=True
        )  # For Cifar10
